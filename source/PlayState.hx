...
class PlayState extends MusicBeatState
{
	...
	public static var ratingStuff:Array<Dynamic> = [
		...
		['TO BAD', 0.4], //From 20% to 39%
		['Sucked', 0.5], //From 40% to 49%
		['Sheet', 0.6], //From 50% to 59%
		['UGH', 0.69], //From 60% to 68%
		['OK', 0.7], //69%
		['Great', 0.8], //From 70% to 79%
		['Nice', 0.9], //From 80% to 89%
		['Good job :) ', 1], //From 90% to 99%
		['Holy Crap!!! You Great Player!!!', 1] //The value on this one isn't used actually, since Perfect is always "1"
	];
	...
	override public function create()
	{
		...
		botplayTxt = new FlxText(400, timeBarBG.y + 55, FlxG.width - 800, "You NOOB", 32);
